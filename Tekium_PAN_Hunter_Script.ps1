...
Write-Host -Object "Tekium PAN Hunter Script for Windows v1.1 - May 2023" -ForegroundColor green
Write-Host -Object "-------------------------------------------------------------------------------------" -ForegroundColor Yellow
...
if ($files_count -gt 0) {
    ...
    $names_files | ForEach-Object -Begin{
        ...
        "Tekium PAN Hunter Script v1.1 for Windows - May 2023" | Out-File -FilePath $log -Append
        "-------------------------------------------------------------------------------------" | Out-File -FilePath $log -Append
